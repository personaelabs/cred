...
export function secp256k1_init_tree(a: number, b: number, c: number, d: number): void;
export function secp256k1_create_proof(a: number, b: number, c: number): void;
export function secp256k1_get_proofs(a: number, b: number, c: number, d: number): void;
